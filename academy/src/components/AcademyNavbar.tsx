          ...
          {showBack ? (
            ...
            <>
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <a href="/about" className={`text-sm transition-all ${textColor} opacity-70 hover:opacity-100 ${hoverColor}`}>About</a>
                <a href="/facilitators" className={`text-sm transition-all ${textColor} opacity-70 hover:opacity-100 ${hoverColor}`}>Facilitators</a>
                <a href="/contact" className={`text-sm transition-all ${textColor} opacity-70 hover:opacity-100 ${hoverColor}`}>Contact</a>
                {auth && (
