...
export default function AcademyNavbar({
  ...
  // Scroll-aware background — track scroll position to switch navbar style
  useEffect(() => {
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-8 min-w-0">
            {showBack ? (
              ...
              <>
                {/* Logo */}
                <a href="/" className="flex items-center gap-2.5 shrink-0" aria-label="Rubikcon Nexus Academy home">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/8">
              <a href="/" className="flex items-center gap-2.5" onClick={() => setMenuOpen(false)}>
                <div className="w-7 h-7 rounded-md bg-[#F5C518] flex items-center justify-center">
                  <span className="font-display font-extrabold text-[#0A0A0A] text-xs leading-none">R</span>
                </div>
